...
export const stateInstitutions: StateInstitution[] = [
  ...
  { name: "Arizona Financial Credit Union", domain: "arizonafinancial.org", type: "credit_union", states: ["AZ"], reviewed: "2026-06-12", deposit: "active", deposit_offer_id: "arizona-financial-cu-200-checking-2026", card: "not_checked" },
  ...
  { name: "Vantage West Credit Union", domain: "vantagewest.org", type: "credit_union", states: ["AZ"], reviewed: "2026-06-12", deposit: "active", deposit_offer_id: "vantage-west-cu-50-checking-2026", card: "not_checked" },
  ...
  { name: "Achieva Credit Union", domain: "achievacu.com", type: "credit_union", states: ["FL"], reviewed: "2026-06-12", deposit: "active", deposit_offer_id: "achieva-cu-150-checking-2026", card: "not_checked" },
  ...
  { name: "Together Credit Union", domain: "togethercu.org", type: "credit_union", states: ["IL","MO"], reviewed: "2026-06-12", deposit: "active", deposit_offer_id: "together-cu-200-checking-2026", card: "not_checked" },
  ...
  { name: "Penn Community Bank", domain: "penncommunitybank.com", type: "bank", states: ["PA"], reviewed: "2026-06-12", deposit: "active", deposit_offer_id: "penn-community-bank-400-checking-2026", card: "not_checked" },
