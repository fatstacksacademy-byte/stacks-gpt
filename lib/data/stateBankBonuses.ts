...
const SEEDS: Seed[] = [
  ...
  {
    id: "arizona-financial-cu-200-checking-2026", bank: "Arizona Financial Credit Union", amount: 200, states: ["AZ"],
  ...
  {
    id: "vantage-west-cu-50-checking-2026", bank: "Vantage West Credit Union", amount: 50, states: ["AZ"],
  ...
  {
    id: "together-cu-200-checking-2026", bank: "Together Credit Union", amount: 200, states: ["MO", "IL"],
    ...
    reqText: "Open a consumer checking account: $50 at opening + $150 after 60 days for 1+ ACH/direct deposit of $500+, 5 Visa debit POS transactions, and eStatements (all within 60 days).",
    feeWaiver: "No monthly fee on eligible checking.",
    ...
    excerpt: "Referred member will receive a $50 bonus at the time of account opening. Additional $150 bonus ... Incentive offer valid June 1, 2026 – June 30, 2026.",
  ...
  {
    id: "achieva-cu-150-checking-2026", bank: "Achieva Credit Union", amount: 150, states: ["FL"],
    dd: 500, payout: 90, scope: "membership", membership: true, online: true, recheck: 60, type: "credit_union", lifetime: true,
    reqText: "Open a new checking account and set up recurring direct deposits aggregating $500+/month. A $100 Refer-A-Friend can bring it to $250.",
    feeWaiver: "No monthly fee on eligible checking.",
    ...
    excerpt: "$150 ... recurring direct deposit aggregate of $500 or more per month on a new checking account.",
  ...
  {
    id: "penn-community-bank-400-checking-2026", bank: "Penn Community Bank", amount: 400, states: ["PA"],
    dd: 1500, ddWindow: 60, debit: 20, open: 25, payout: 45, mustOpen: 180, scope: "regional", membership: false, online: true, recheck: 7, type: "bank", exp: "2026-06-27", lifetime: true,
    reqText: "Open any personal checking ($25, promo code 400BONUS) and within 60 days either receive direct deposits totaling $1,500+ OR make 20+ debit purchases of $20+ each.",
    feeWaiver: "No monthly fee on eligible checking.",
    notes: "Penn Community Bank (Bucks/Montgomery County, PA region). New customers (no PCB checking closed in the prior 12 months / no prior incentive); one per household. Account must stay open 6 months (early closing reverses the bonus). Paid within 45 days. Deadline June 27, 2026. (A $475 variant exists for select branches/online via code 475BONUS.)",
    excerpt: "either DD totaling $1,500+ OR 20+ debit purchases of $20+ ... promo code 400BONUS ... deadline June 27, 2026.",
    src: ["https://www.penncommunitybank.com/400bonus/"],
  },
  {
