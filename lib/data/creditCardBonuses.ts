...
export const creditCardBonuses: CreditCardBonus[] = [
  ...
  },
  {
    ...
    key_benefits: ["No Foreign Transaction Fees"],
    rewards: [
      { categories: ["special"], multiplier: 5, unit: "%", note: "eligible gas at Costco" },
      { categories: ["ev_charging","gas_stations"], multiplier: 4, unit: "%", annual_cap: 7000, note: "combined annual cap with Costco gas; 1% thereafter" },
      { categories: ["dining","travel"], multiplier: 3, unit: "%" },
      { categories: ["costco_wholesale"], multiplier: 2, unit: "%" },
      { categories: ["all_other"], multiplier: 1, unit: "%" },
    ],
  },
  {
  ...
  // ─── MISSING AIRLINE / HOTEL COBRANDS (added 2026-06-12 catalog deep-dive) ──
  {
    id: "barclays-lufthansa-miles-more-50k",
    card_name: "Lufthansa Miles & More World Elite Mastercard",
    issuer: "barclays",
    card_type: "personal",
    bonus_amount: 50000,
    bonus_currency: "Miles & More miles",
    is_hotel_card: false,
    cpp_value: 1.5,
    min_spend: 3000,
    spend_months: 3,
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://cards.barclaycardus.com/banking/cards/lufthansa-miles-more-world-elite-mastercard/",
    expired: false,
    key_benefits: [
      "50,000 award miles after $3,000 spend in 90 days (annual fee paid)",
      "Additional 20,000 miles after $12,000 spend in first year (up to 70k total)",
      "Companion ticket each account anniversary",
      "Miles do not expire with card activity",
    ],
    offer_verified_at: "2026-06-12",
    travel: { no_foreign_tx_fee: true },
  },
  {
    id: "synchrony-sun-country-25k",
    card_name: "Sun Country Airlines Visa Signature Card",
    issuer: "synchrony",
    card_type: "personal",
    bonus_amount: 25000,
    bonus_currency: "Sun Country Rewards points",
    is_hotel_card: false,
    cpp_value: 1.0,
    min_spend: 1000,
    spend_months: 3,
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://www.synchrony.com/partner/sun-country/benefits",
    expired: false,
    key_benefits: [
      "25,000 bonus points after $1,000 spend in 90 days",
      "Free first checked bag for cardholder",
      "20% back on Sun Country inflight purchases",
      "Points do not expire",
    ],
    offer_verified_at: "2026-06-12",
  },
  {
    id: "barclays-breeze-easy-50k",
    card_name: "Breeze Easy Visa Signature Card",
    issuer: "barclays",
    card_type: "personal",
    bonus_amount: 50000,
    bonus_currency: "BreezePoints",
    is_hotel_card: false,
    cpp_value: 1.0,
    min_spend: 4000,
    spend_months: 3,
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://cards.barclaycardus.com/banking/cards/breeze-airways/",
    expired: false,
    key_benefits: [
      "50,000 BreezePoints after $4,000 spend in 90 days",
      "Up to 10x BreezePoints on Breeze purchases",
  ...
  {
    id: "usbank-aeromexico-visa-signature-15k",
    card_name: "Aeromexico Visa Signature Card",
    issuer: "us-bank",
    card_type: "personal",
    bonus_amount: 15000,
    bonus_currency: "Aeromexico Rewards miles",
    is_hotel_card: false,
    cpp_value: 1.0,
    min_spend: 0,
    spend_months: 3,
    ...
    annual_fee_waived_first_year: true,
    statement_credits_year1: 0,
    offer_link: "https://www.usbank.com/credit-cards/aeromexico-visa-signature-card.html",
    expired: false,
    key_benefits: [
      "15,000 bonus miles after first purchase (no minimum spend)",
      "Annual companion certificate",
      "Free first checked bag",
      "$80 annual fee waived the first year",
    ],
    offer_verified_at: "2026-06-12",
  },
  {
    id: "commerce-drury-rewards-25k",
    card_name: "Drury Rewards Visa Credit Card",
    issuer: "commerce-bank",
    card_type: "personal",
    bonus_amount: 25000,
    bonus_currency: "Drury Rewards points",
    is_hotel_card: true,
    cpp_value: 0.6,
    min_spend: 500,
    spend_months: 3,
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://www.commercebank.com/personal/cards/drury-rewards-visa",
    expired: false,
    key_benefits: [
      "25,000 bonus points after $500 spend in 90 days",
      "$0 annual fee",
      "Earn points toward free nights at Drury Hotels",
    ],
    state_restricted: ["MO", "KS", "IL", "OK", "CO"],
    eligibility_scope: "selected_areas",
    eligibility_notes: "Issued by Commerce Bank; availability is concentrated in the Commerce Bank footprint (MO, KS, IL, OK, CO and nearby states).",
    eligibility_source: "https://www.commercebank.com/personal/cards/drury-rewards-visa",
    offer_verified_at: "2026-06-12",
  },
