...
export const creditCardBonuses: CreditCardBonus[] = [
  ...
  },
  {
    ...
    issuer: "chase",
    card_type: "personal",
    bonus_amount: 75000, // 50k + 10k AU authorized user bonus
  ...
  {
    id: "us-bank-us-bank-cash-plus-auto",
    card_name: "US Bank Cash Plus",
    issuer: "us bank",
    card_type: "personal",
    bonus_amount: 250,
    bonus_currency: "cash",
    ...
    offer_link: "https://www.usbank.com/credit-cards/cash-plus-visa-signature-credit-card.html",
    expired: false,
    key_benefits: ["1% everything_else", "5% travel", "2% groceries"],
    rewards: [
      { categories: ["everything_else"], multiplier: 1, unit: "%" },
      { categories: ["travel"], multiplier: 5, unit: "%" },
      { categories: ["groceries"], multiplier: 2, unit: "%" }
    ],
    // Auto-imported from seed://curated — verify before relying on: no_spend_requirement_found
  },

  {
    id: "chase-chase-southwest-rapid-rewards-premier-auto",
    card_name: "Chase Southwest Rapid Rewards Premier",
    issuer: "chase",
    card_type: "personal",
    bonus_amount: 85000,
    bonus_currency: "Points",
  ...
  {
    id: "chase-chase-disney-premier-visa-auto",
    card_name: "Chase Disney Premier Visa",
    issuer: "chase",
    card_type: "personal",
    bonus_amount: 100,
    bonus_currency: "cash",
  ...
  {
    id: "chase-chase-british-airways-visa-signature-auto",
    card_name: "Chase British Airways Visa Signature",
    issuer: "chase",
    card_type: "personal",
    bonus_amount: 75000,
    bonus_currency: "points",
  ...
  {
    id: "chase-chase-united-questsm-auto",
    card_name: "Chase United QuestSM",
    issuer: "chase",
    card_type: "personal",
    bonus_amount: 70000,
    bonus_currency: "Miles",
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://creditcards.chase.com/travel-credit-cards/united/united-quest?iCELL=61FY",
    expired: false,
    key_benefits: ["2x travel", "2x dining", "2x streaming"],
    rewards: [
      { categories: ["travel"], multiplier: 2, unit: "miles" },
      { categories: ["dining"], multiplier: 2, unit: "miles" },
      { categories: ["streaming"], multiplier: 2, unit: "miles" }
    ],
    // Auto-imported from https://creditcards.chase.com/personal-credit-cards — verify before relying on: clean
  },

  {
    id: "chase-chase-marriott-bonvoy-bountiful-auto",
    card_name: "Chase Marriott Bonvoy Bountiful",
    issuer: "chase",
    card_type: "personal",
    bonus_amount: 85000,
    bonus_currency: "Points",
    ...
    expired: false,
    key_benefits: [],
    // Auto-imported from https://creditcards.chase.com/personal-credit-cards — verify before relying on: no_spend_requirement_found, free_night_card
  },

  {
    id: "chase-chase-ihg-one-rewards-traveler-auto",
    card_name: "Chase IHG One Rewards Traveler",
    issuer: "chase",
    card_type: "personal",
    bonus_amount: 80000,
    bonus_currency: "Points",
    ...
    offer_link: "https://creditcards.chase.com/travel-credit-cards/ihg-rewards-club/traveler?iCELL=61FY",
    expired: false,
    key_benefits: ["3x gas", "3x dining"],
    rewards: [
      { categories: ["gas"], multiplier: 3, unit: "points" },
      { categories: ["dining"], multiplier: 3, unit: "points" }
    ],
    // Auto-imported from https://creditcards.chase.com/personal-credit-cards — verify before relying on: free_night_card
  },

  {
    id: "chase-chase-disney-inspire-visa-auto",
    card_name: "Chase Disney Inspire Visa",
    issuer: "chase",
    card_type: "personal",
    bonus_amount: 200,
    bonus_currency: "cash",
  ...
  {
    id: "bofa-bank-of-america-unlimited-cash-back-student-auto",
    card_name: "Bank of America Unlimited Cash Back Student",
    issuer: "bofa",
    card_type: "personal",
    bonus_amount: 0,
    bonus_currency: "cash",
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://www.bankofamerica.com/credit-cards/products/unlimited-cash-back-student-credit-card/",
    expired: false,
    key_benefits: [],
    // Auto-imported from https://www.bankofamerica.com/credit-cards/ — verify before relying on: no_bonus_amount_found, no_spend_requirement_found
  },

  {
    id: "bofa-bank-of-america-student-rewards-auto",
    card_name: "Bank of America Student Rewards",
    issuer: "bofa",
    card_type: "personal",
    bonus_amount: 0,
    bonus_currency: "cash",
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://www.bankofamerica.com/credit-cards/products/student-rewards-credit-card/",
    expired: false,
    key_benefits: [],
    // Auto-imported from https://www.bankofamerica.com/credit-cards/ — verify before relying on: no_bonus_amount_found, no_spend_requirement_found
  },
  ...
  {
    id: "bofa-bank-of-america-susan-komen-auto",
    card_name: "Bank of America Susan Komen",
    issuer: "bofa",
    card_type: "personal",
    bonus_amount: 0,
    bonus_currency: "cash",
  ...
  {
    id: "chase-chase-united-gatewaysm-auto",
    card_name: "Chase United GatewaySM",
    issuer: "chase",
    card_type: "personal",
    bonus_amount: 40000,
    bonus_currency: "Miles",
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://creditcards.chase.com/travel-credit-cards/united/united-gateway?iCELL=61FY",
    expired: false,
    intro_apr: { purchase_apr_months: 12 },
    key_benefits: ["2x everything_else", "2x gas"],
    rewards: [
      { categories: ["everything_else"], multiplier: 2, unit: "miles" },
      { categories: ["gas"], multiplier: 2, unit: "miles" }
    ],
    // Auto-imported from https://creditcards.chase.com/personal-credit-cards — verify before relying on: clean
  },

  {
    id: "chase-chase-freedom-rise-auto",
    ...
    offer_link: "https://creditcards.chase.com/cash-back-credit-cards/freedom/rise?iCELL=61FY",
    expired: false,
    key_benefits: ["3% dining", "1.5% everything_else"],
    rewards: [
      { categories: ["dining"], multiplier: 3, unit: "%" },
      { categories: ["everything_else"], multiplier: 1.5, unit: "%" }
    ],
    // Auto-imported from https://creditcards.chase.com/personal-credit-cards — verify before relying on: no_bonus_amount_found, no_spend_requirement_found
  },

  {
    id: "chase-chase-disney-visa-auto",
    card_name: "Chase Disney Visa",
    issuer: "chase",
    card_type: "personal",
    bonus_amount: 50,
    bonus_currency: "cash",
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://creditcards.chase.com/rewards-credit-cards/disney/rewards?iCELL=61FY",
    expired: false,
    key_benefits: [],
    // Auto-imported from https://creditcards.chase.com/personal-credit-cards — verify before relying on: clean
  },
  ...
  {
    id: "wells-fargo-wells-fargo-autograph-visa-auto",
    card_name: "Wells Fargo Autograph Visa",
    issuer: "wells fargo",
    card_type: "personal",
    bonus_amount: 20000,
    bonus_currency: "Points",
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://creditcards.wellsfargo.com/autograph-visa-credit-card/?FPID=012988I6P10000&product_code=CC&subproduct_code=AU&cx_nm=CXNAME_CSMPD_MC_carousel&sub_channel=WEB&vendor_code=WF&lp_cx_nm=CXNAME_CSMPD_MC_carousel_CG",
    expired: false,
    intro_apr: { purchase_apr_months: 12 },
    key_benefits: [],
    // Auto-imported from https://creditcards.wellsfargo.com/ — verify before relying on: no_spend_requirement_found
  },

  {
    id: "wells-fargo-wells-fargo-autograph-journey-visa-auto",
    card_name: "Wells Fargo Autograph Journey Visa",
    issuer: "wells fargo",
    card_type: "personal",
    bonus_amount: 60000,
    bonus_currency: "Points",
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://creditcards.wellsfargo.com/autograph-journey-visa-credit-card/?FPID=0127E1I0P10000&product_code=CC&subproduct_code=MT&sub_channel=WEB&vendor_code=WF&cx_nm=CXNAME_CSMPD_MC&lp_cx_nm=CXNAME_CSMPD_MC_carousel_CG",
    expired: false,
    key_benefits: ["3x dining"],
    rewards: [
      { categories: ["dining"], multiplier: 3, unit: "points" }
    ],
    // Auto-imported from https://creditcards.wellsfargo.com/ — verify before relying on: no_spend_requirement_found
  ...
  {
    id: "wells-fargo-wells-fargo-one-key-auto",
    card_name: "Wells Fargo One Key",
    issuer: "wells fargo",
    card_type: "personal",
    bonus_amount: 0,
    bonus_currency: "cash",
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://creditcards.wellsfargo.com/one-key-credit-card/?FPID=21231JIXE50000&product_code=CC&subproduct_code=OW&sub_channel=WEB&vendor_code=WF&cx_nm=CXNAME_CSMPD_MC&lp_cx_nm=CXNAME_CSMPD_MC_carousel_CG",
    expired: false,
    key_benefits: [],
    // Auto-imported from https://creditcards.wellsfargo.com/ — verify before relying on: no_bonus_amount_found
  },

  {
    id: "wells-fargo-wells-fargo-one-key-plus-auto",
    card_name: "Wells Fargo One Key Plus",
    issuer: "wells fargo",
    card_type: "personal",
    bonus_amount: 0,
    bonus_currency: "cash",
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://creditcards.wellsfargo.com/one-key-plus-credit-card/?FPID=21271KIXE50000&product_code=CC&subproduct_code=OF&sub_channel=WEB&vendor_code=WF&cx_nm=CXNAME_CSMPD_MC&lp_cx_nm=CXNAME_CSMPD_MC_carousel_CG",
    expired: false,
    key_benefits: [],
    // Auto-imported from https://creditcards.wellsfargo.com/ — verify before relying on: no_bonus_amount_found
  },
  ...
  {
    id: "bofa-bank-of-america-cash-back-auto",
    card_name: "Bank of America Cash Back",
    issuer: "bofa",
    card_type: "personal",
    bonus_amount: 0,
    bonus_currency: "cash",
  ...
  {
    id: "chase-chase-southwest-rapid-rewards-plus-auto",
  ...
  {
    id: "us-bank-u-s-bank-altitude-go-auto",
    card_name: "U.S. Bank Altitude GO",
    issuer: "us bank",
    card_type: "personal",
    bonus_amount: 20000,
    bonus_currency: "Points",
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://www.usbank.com/credit-cards/altitude-go-visa-signature-credit-card.html",
    expired: false,
    key_benefits: ["4% dining"],
    rewards: [
      { categories: ["dining"], multiplier: 4, unit: "%" }
    ],
    // Auto-imported from https://www.usbank.com/credit-cards.html — verify before relying on: no_spend_requirement_found
  },

  {
    id: "bofa-bank-of-america-unlimited-cash-back-auto",
    card_name: "Bank of America Unlimited Cash Back",
    issuer: "bofa",
    card_type: "personal",
    bonus_amount: 0,
    bonus_currency: "cash",
  ...
  {
    id: "bofa-bank-of-america-student-cash-back-auto",
    card_name: "Bank of America Student Cash Back",
    issuer: "bofa",
    card_type: "personal",
    bonus_amount: 0,
    bonus_currency: "cash",
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://www.bankofamerica.com/credit-cards/products/student-cash-back-credit-card/",
    expired: false,
    key_benefits: ["2% groceries"],
    rewards: [
      { categories: ["groceries"], multiplier: 2, unit: "%" }
  ...
  {
    id: "us-bank-u-s-bank-cash-plus-auto",
    card_name: "U.S. Bank Cash Plus",
    issuer: "us bank",
    card_type: "personal",
    bonus_amount: 250,
    bonus_currency: "cash",
  ...
  {
    id: "chase-chase-southwest-rapid-rewards-priority-auto",
    card_name: "Chase Southwest Rapid Rewards Priority",
    issuer: "chase",
    card_type: "personal",
    bonus_amount: 90000,
    bonus_currency: "Points",
    ...
    key_benefits: ["2x gas"],
    rewards: [
      { categories: ["gas"], multiplier: 2, unit: "points" }
    ],
    // Auto-imported from https://creditcards.chase.com/personal-credit-cards — verify before relying on: clean
  },

  {
    id: "chase-chase-southwest-rapid-rewards-premier-business-auto",
    card_name: "Chase Southwest Rapid Rewards Premier Business",
    issuer: "chase",
    card_type: "business",
    bonus_amount: 60000,
    bonus_currency: "Points",
  ...
  {
    id: "chase-chase-sapphire-reserve-for-businesssm-auto",
    card_name: "Chase Sapphire Reserve for BusinessSM",
    issuer: "chase",
    card_type: "personal",
    bonus_amount: 200000,
    bonus_currency: "Points",
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://creditcards.chase.com/business-credit-cards/sapphire/reserve?iCELL=61FY",
    expired: false,
    key_benefits: ["8x travel", "4x travel"],
    rewards: [
      { categories: ["travel"], multiplier: 8, unit: "points" },
      { categories: ["travel"], multiplier: 4, unit: "points" }
    ],
    // Auto-imported from https://creditcards.chase.com/personal-credit-cards — verify before relying on: no_spend_requirement_found
  },

  {
    id: "chase-chase-united-clubsm-business-auto",
    card_name: "Chase United ClubSM Business",
    issuer: "chase",
    card_type: "business",
    bonus_amount: 110000,
    bonus_currency: "Miles",
  ...
  {
    id: "chase-chase-southwest-rapid-rewards-performance-busine-auto",
    card_name: "Chase Southwest Rapid Rewards Performance Business",
    issuer: "chase",
    card_type: "business",
    bonus_amount: 80000,
    bonus_currency: "Points",
  ...
  {
    id: "chase-chase-unitedsm-business-auto",
    card_name: "Chase UnitedSM Business",
    issuer: "chase",
    card_type: "business",
    bonus_amount: 110000,
    bonus_currency: "Miles",
    ...
    annual_fee_waived_first_year: false,
    statement_credits_year1: 0,
    offer_link: "https://creditcards.chase.com/business-credit-cards/united/united-business-card?iCELL=61FY",
    expired: false,
    key_benefits: ["2x everything_else", "2x dining"],
    rewards: [
      { categories: ["everything_else"], multiplier: 2, unit: "miles" },
      { categories: ["dining"], multiplier: 2, unit: "miles" }
    ],
  ...
  {
    id: "chase-chase-world-of-hyatt-business-auto",
    card_name: "Chase World of Hyatt Business",
    issuer: "chase",
    card_type: "business",
    bonus_amount: 60000,
    bonus_currency: "Points",
