        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 24 }}>
          ...
          <button onClick={() => handleCheckout("annual")} disabled={loading !== null}
            style={{
              ...
              cursor: loading ? "wait" : "pointer", display: "flex", justifyContent: "space-between", alignItems: "center",
            }}>
          ...
          <button onClick={() => handleCheckout("monthly")} disabled={loading !== null}
            ...
            <span style={{ fontSize: 18, fontWeight: 800, color: "#111" }}>
              {loading === "monthly" ? "..." : "$5"}<span style={{ fontSize: 13, fontWeight: 400, color: "#999" }}>/mo</span>
            </span>
          </button>
        </div>
