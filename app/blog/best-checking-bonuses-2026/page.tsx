    ...
    <>
      ...
      <header style={{ borderBottom: "1px solid #1a1a1a", padding: "16px 0" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <nav style={{ display: "flex", gap: 24, alignItems: "center" }}>
            <Link href="/blog/best-checking-bonuses-2026" style={{ fontSize: 13, color: "#88e06d", textDecoration: "none", fontWeight: 600 }}>Best Checking</Link>
      ...
      <main style={{ maxWidth: 800, margin: "0 auto", padding: "48px 24px 60px" }}>
                ...
                <div style={{
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }}>
                      ...
                      <span style={{ fontSize: 16, fontWeight: 800, color: "#88e06d" }}>{money(b.bonus_amount)}</span>
        ...
        <div style={{ marginTop: 48 }}>
          <h2 style={{ fontSize: 22, fontWeight: 700, color: "#fff", margin: "0 0 16px" }}>How to Get Started With Checking Bonuses</h2>
          <div style={{ fontSize: 14, color: "#bbb", lineHeight: 1.8 }}>
            ...
            <p style={{ margin: "0 0 12px" }}>
              <strong style={{ color: "#fff" }}>Start with Chase ($400).</strong> It has the simplest requirements ($1,000 DD in 90 days) and the fastest payout (~15 days). After Chase, move to Wells Fargo ($400) and then work through the list.
            </p>
            <p style={{ margin: "0 0 12px" }}>
              <strong style={{ color: "#fff" }}>Split your direct deposit</strong> to work on multiple bonuses at once. Most employers allow you to send portions of your paycheck to different accounts.
            </p>
            <p style={{ margin: 0 }}>
              <strong style={{ color: "#fff" }}>Track your bonuses.</strong> Use <Link href="/" style={{ color: "#88e06d", textDecoration: "none" }}>Stacks OS</Link> to keep track of which bonuses you{"'"}re working on, what{"'"}s next, and your total earnings.
            </p>
          </div>
        </div>
        ...
        <div style={{ marginTop: 40, padding: "24px", background: "rgba(255,0,0,0.05)", border: "1px solid rgba(255,0,0,0.15)", borderRadius: 12 }}>
          <div style={{ fontSize: 16, fontWeight: 700, color: "#fff", marginBottom: 8 }}>Watch: The Best Checking Bonuses of 2026</div>
