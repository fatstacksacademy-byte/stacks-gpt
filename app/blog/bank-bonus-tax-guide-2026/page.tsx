  ...
  return (
    <>
      ...
      <main style={{ maxWidth: 800, margin: "0 auto", padding: "48px 24px 60px" }}>
        ...
        <p style={para}>
          Bank bonuses are taxed at your <strong style={{ color: "#fff" }}>ordinary income tax rate</strong>, which is the same rate applied to your salary, wages, and interest income. For the 2026 tax year, federal ordinary income rates range from 10% to 37% depending on your taxable income and filing status.
        </p>
        <p style={para}>
        ...
        <p style={para}>
          Banks are required to issue a 1099-INT when the total interest paid (including bonuses classified as interest) is <strong style={{ color: "#fff" }}>$10 or more</strong> during the tax year. If you earned $8 in interest and received a $300 bonus, the 1099-INT will show $308.
        </p>
        ...
        <p style={para}>
          Banks are required to issue a 1099-MISC when the total miscellaneous payments are <strong style={{ color: "#fff" }}>$600 or more</strong> during the tax year. This higher threshold means you are less likely to receive a 1099-MISC for smaller bonuses, but you are still required to report the income.
        </p>

        <h3 style={subHeading}>Reporting Threshold Summary</h3>
        <div style={{ border: "1px solid #1a1a1a", borderRadius: 12, overflow: "hidden", marginTop: 16, marginBottom: 24 }}>
          ...
          <div style={tableRow}>
            <span style={{ color: "#fff", fontWeight: 600 }}>1099-INT</span>
            <span>$10+</span>
            <span>Savings bonuses, most checking bonuses</span>
          </div>
          <div style={{ ...tableRow, borderBottom: "none" }}>
            <span style={{ color: "#fff", fontWeight: 600 }}>1099-MISC</span>
            <span>$600+</span>
        ...
        <ul style={{ padding: "0 0 0 20px", margin: "0 0 16px" }}>
          <li style={listItem}>Enter the amount on <strong style={{ color: "#fff" }}>Schedule B, Part I (Interest)</strong> of your Form 1040.</li>
          ...
          <li style={listItem}>The total flows to <strong style={{ color: "#fff" }}>Form 1040, Line 2b</strong> (Taxable Interest).</li>
        ...
        <ul style={{ padding: "0 0 0 20px", margin: "0 0 16px" }}>
          <li style={listItem}>Enter the amount on <strong style={{ color: "#fff" }}>Schedule 1, Line 8z</strong> (Other Income) with a description like &quot;bank bonus&quot; or &quot;account bonus.&quot;</li>
          <li style={listItem}>The total from Schedule 1 flows to <strong style={{ color: "#fff" }}>Form 1040, Line 8</strong> (Other Income).</li>
          <li style={listItem}>1099-MISC income reported in Box 3 is <strong style={{ color: "#fff" }}>not subject to self-employment tax</strong>. This is an important distinction. You owe income tax but not the additional 15.3% SE tax.</li>
        </ul>
        ...
        <ul style={{ padding: "0 0 0 20px", margin: "0 0 16px" }}>
          <li style={listItem}><strong style={{ color: "#fff" }}>You must still report the income.</strong> The IRS expects you to report all income regardless of whether a 1099 was issued.</li>
          <li style={listItem}><strong style={{ color: "#fff" }}>Keep your own records.</strong> Save screenshots of bonus postings, account statements showing the bonus credit, and any promotional emails confirming the bonus amount and date.</li>
          <li style={listItem}><strong style={{ color: "#fff" }}>Wait until mid-February before filing.</strong> 1099 forms are due to taxpayers by January 31, but mail delivery can take 2-3 weeks. Check your online banking portals as well, since many banks make 1099s available electronically.</li>
          <li style={listItem}><strong style={{ color: "#fff" }}>Contact the bank if a 1099 seems missing.</strong> If you received a bonus of $10+ (for 1099-INT) or $600+ (for 1099-MISC) and have not received a form by mid-February, call the bank to request a copy.</li>
        </ul>
        ...
        <ul style={{ padding: "0 0 0 20px", margin: "0 0 16px" }}>
          <li style={listItem}><strong style={{ color: "#fff" }}>Log every bonus when it posts.</strong> Record the bank name, bonus amount, date posted, and account type (checking or savings).</li>
          <li style={listItem}><strong style={{ color: "#fff" }}>Note the expected 1099 type.</strong> Check the bank&apos;s terms to determine if the bonus will be reported as 1099-INT or 1099-MISC. This helps you cross-reference when forms arrive.</li>
          <li style={listItem}><strong style={{ color: "#fff" }}>Track 1099 receipt during tax season.</strong> As each 1099 arrives in January and February, check it off your list and verify the amounts match your records.</li>
          <li style={listItem}><strong style={{ color: "#fff" }}>Flag discrepancies immediately.</strong> If a 1099 shows a different amount than you expected, contact the bank before filing. Correcting a 1099 after filing is more complicated.</li>
          <li style={listItem}><strong style={{ color: "#fff" }}>Keep records for at least 3 years.</strong> The IRS can audit returns up to 3 years after filing (6 years if income is substantially understated). Retain all 1099s, account statements, and bonus confirmation emails.</li>
        </ul>
        <p style={para}>
          <Link href="/" style={{ color: "#88e06d", textDecoration: "none", fontWeight: 600 }}>Stacks OS</Link> includes built-in tracking for bank bonuses with fields for bonus amount, post date, and tax status. Instead of managing a manual spreadsheet, you can track your entire bonus pipeline and export the data at tax time.
        </p>
        ...
        <div style={{ border: "1px solid #1a1a1a", borderRadius: 12, overflow: "hidden", marginTop: 16 }}>
          <div style={{ padding: "20px 24px", borderBottom: "1px solid #1a1a1a" }}>
            <div style={{ fontSize: 16, fontWeight: 700, color: "#fff", marginBottom: 6 }}>Scenario 1: Single Bonus</div>
            <p style={{ fontSize: 14, color: "#999", lineHeight: 1.7, margin: 0 }}>
              ...
              <br />Tax owed: $400 x 27% = <strong style={{ color: "#fff" }}>$108</strong>. Net profit: <strong style={{ color: "#88e06d" }}>$292</strong>.
            </p>
          </div>
          <div style={{ padding: "20px 24px", borderBottom: "1px solid #1a1a1a" }}>
            <div style={{ fontSize: 16, fontWeight: 700, color: "#fff", marginBottom: 6 }}>Scenario 2: Multiple Bonuses</div>
            <p style={{ fontSize: 14, color: "#999", lineHeight: 1.7, margin: 0 }}>
              You earn bonuses from Chase ($400), Citi ($325), BMO ($600), SoFi ($400), and Bank of America ($500) = $2,225 total.
              Same 27% rate.
              <br />Tax owed: $2,225 x 27% = <strong style={{ color: "#fff" }}>$601</strong>. Net profit: <strong style={{ color: "#88e06d" }}>$1,624</strong>.
            </p>
          </div>
          <div style={{ padding: "20px 24px" }}>
            <div style={{ fontSize: 16, fontWeight: 700, color: "#fff", marginBottom: 6 }}>Scenario 3: High Earner, No State Tax</div>
            <p style={{ fontSize: 14, color: "#999", lineHeight: 1.7, margin: 0 }}>
              You earn $3,000 in bank bonuses and live in Texas (no state income tax). You are in the 32% federal bracket.
              <br />Tax owed: $3,000 x 32% = <strong style={{ color: "#fff" }}>$960</strong>. Net profit: <strong style={{ color: "#88e06d" }}>$2,040</strong>.
            </p>
          </div>
        </div>
        ...
        <ul style={{ padding: "0 0 0 20px", margin: "0 0 16px" }}>
          <li style={listItem}><strong style={{ color: "#fff" }}>Not reporting bonuses below the 1099 threshold.</strong> A $50 credit union bonus without a 1099 is still taxable income.</li>
          <li style={listItem}><strong style={{ color: "#fff" }}>Double-counting or missing a 1099.</strong> When you have 10+ accounts, it is easy to enter a 1099 twice or miss one entirely. Cross-reference your tracking list carefully.</li>
          <li style={listItem}><strong style={{ color: "#fff" }}>Confusing the tax year.</strong> The bonus is taxable in the year it posts to your account, not the year you opened the account or met the requirements. A bonus that posts on January 5, 2027, goes on your 2027 return even if you did all the work in 2026.</li>
          <li style={listItem}><strong style={{ color: "#fff" }}>Not making estimated payments.</strong> If your bonus income pushes your total underwithholding above $1,000 for the year, you may owe an underpayment penalty.</li>
          <li style={listItem}><strong style={{ color: "#fff" }}>Reporting 1099-MISC Box 3 income as self-employment income.</strong> Bank bonuses reported on 1099-MISC Box 3 are &quot;other income,&quot; not self-employment income. Do not report them on Schedule C. This would cause you to pay unnecessary self-employment tax.</li>
        </ul>
        ...
        <div style={{ marginTop: 48, padding: "32px", background: "rgba(136,224,109,0.04)", border: "1px solid rgba(136,224,109,0.15)", borderRadius: 12 }}>
          <div style={{ fontSize: 18, fontWeight: 700, color: "#fff", marginBottom: 8 }}>Track Bonuses and Tax Status With Stacks OS</div>
        ...
        <div style={{ marginTop: 24, padding: "24px", background: "rgba(255,0,0,0.05)", border: "1px solid rgba(255,0,0,0.15)", borderRadius: 12 }}>
          <div style={{ fontSize: 16, fontWeight: 700, color: "#fff", marginBottom: 8 }}>Watch: How to Handle Bank Bonus Taxes</div>
        ...
        <div style={{ marginTop: 32, display: "flex", gap: 20, flexWrap: "wrap" }}>
          ...
          <Link href="/blog/what-counts-as-direct-deposit" style={{ fontSize: 14, color: "#88e06d", textDecoration: "none", fontWeight: 600 }}>Direct deposit guide &rarr;</Link>
        </div>
      </main>
